...
rmarkp_node_:
	...
	mov	rbp,qword ptr rmarkp_queue_first_offset[r9]
	mov	rdx,qword ptr rmarkp_n_queue_items_16_offset[r9]

	prefetch	[rcx]
	mov	qword ptr rmarkp_queue_offset[r9+rbp],rcx
	mov	qword ptr rmarkp_queue_offset+8[r9+rbp],rsi
	mov	qword ptr rmarkp_queue_offset+16[r9+rbp],rbx
	lea	rbx,[rbp+rdx]
	add	rbp,32
	...
	mov	qword ptr rmarkp_queue_first_offset[r9],rbp
...
rmarkp_add_item2:
	...
	mov	qword ptr rmarkp_queue_offset[r9+rbp],rcx
	mov	qword ptr rmarkp_queue_offset+8[r9+rbp],rsi
	mov	qword ptr rmarkp_queue_offset+16[r9+rbp],-1
	add	rbp,32
	and	rbp,7*32
	...
	mov	qword ptr rmarkp_queue_first_offset[r9],rbp
	mov	qword ptr rmarkp_n_queue_items_16_offset[r9],rdx
...
rmarkp_add_item3:
	...
	mov	qword ptr rmarkp_queue_offset+8[r9+rbp],rsi
	mov	qword ptr rmarkp_queue_offset+16[r9+rbp],rsi
	add	rbp,32
	and	rbp,7*32
...
rmarkp_last_item_in_queue:
	mov	rcx,qword ptr rmarkp_queue_offset[r9+rbx]

	mov	rax,qword ptr neg_heap_p3_offset[r9]

	mov	rsi,qword ptr rmarkp_queue_offset+8[r9+rbx]
	mov	rbx,qword ptr rmarkp_queue_offset+16[r9+rbx]
